...
const calcComput = require("../src/js/app.js").threeCalc;

// pending
xdescribe('arrayCheck', function()
{
...
describe('Limits of Array', function ()
{
  it('testing random array values in array', function()
  {
    expect(calcComput(testArray), 'should equal 49').to.deep.equal(49);
  });

  it('should return an integer w/ decimal output', function()
  {
